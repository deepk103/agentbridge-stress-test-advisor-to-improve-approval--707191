terraform {
  ...
  backend "s3" {
    ...
    key                         = "deployments/stress-test-advisor-to-improve-approval-/terraform.tfstate"
    region                      = "us-east-1"
...
resource "digitalocean_project" "main" {
  name        = "ab-stress-test-advisor-to-improve-approval-"
  description = "AgentBridge: Stress Test Advisor to improve approval rate"
...
resource "digitalocean_vpc" "main" {
  name        = "ab-stress-test-advisor-to-improve-approval--vpc"
  region      = var.region
  ip_range    = var.vpc_cidr
  description = "Isolated VPC for AgentBridge Stress Test Advisor to improve approval rate"
}
...
resource "digitalocean_ssh_key" "deploy" {
  ...
  name       = "ab-stress-test-advisor-to-improve-approval--deploy"
...
resource "digitalocean_firewall" "main" {
  name = "ab-stress-test-advisor-to-improve-approval--fw"
...
resource "digitalocean_droplet" "main" {
  ...
  tags = concat([
    "agentbridge",
    "blueprint-stress-test-advisor-to-improve-approval-",
    var.environment,
...
resource "digitalocean_volume" "data" {
  ...
  region                  = var.region
  name                    = "ab-stress-test-advisor-to-improve-approval--data"
  size                    = var.additional_storage_gb
  initial_filesystem_type = "ext4"
  description             = "Persistent data for AgentBridge Stress Test Advisor to improve approval rate"

  tags = ["agentbridge", "blueprint-stress-test-advisor-to-improve-approval-", "data"]
}
...
resource "digitalocean_spaces_bucket" "artifacts" {
  ...
  name   = "ab-stress-test-advisor-to-improve-approval--artifacts"
...
resource "digitalocean_loadbalancer" "main" {
  ...
  name   = "ab-stress-test-advisor-to-improve-approval--lb"
  region = var.region
  vpc_uuid = digitalocean_vpc.main.id
...
resource "digitalocean_monitor_alert" "cpu_high" {
  ...
  description = "AgentBridge stress-test-advisor-to-improve-approval-: CPU > 85% for 5 min"
}
...
resource "digitalocean_monitor_alert" "memory_high" {
  ...
  enabled     = true
  entities    = [digitalocean_droplet.main.id]
  description = "AgentBridge stress-test-advisor-to-improve-approval-: Memory > 90% for 5 min"
}
...
resource "digitalocean_monitor_alert" "disk_high" {
  ...
  enabled     = true
  entities    = [digitalocean_droplet.main.id]
  description = "AgentBridge stress-test-advisor-to-improve-approval-: Disk > 85%"
}
